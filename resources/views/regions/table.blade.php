        ...
        @foreach($regions as $region)
            <tr>
                ...
                <td>
                    ...
                    <div class='btn-group'>
                        <!--<a href="{{ route('regions.show', [$region->id]) }}" class='btn btn-default btn-xs'>Editar</a>-->
                        <a href="{{ route('regions.edit', [$region->id]) }}" class='btn btn-default btn-xs'>Editar</a>
                        {!! Form::button('Eliminar', ['type' => 'submit', 'class' => 'btn btn-danger btn-xs', 'onclick' => "return confirm('Seguro?')"]) !!}
                    </div>
                    {!! Form::close() !!}
                </td>
            </tr>
